...
! function (e, t) {
   ...
   function v(e, t) {
      if (e.parentNode && (h || M(e))) {
         ...
         return t && (n ? (g = g || v(e),
               ...
               g.appendChild(s)) : (f || ((f = v(e)).style.cssText = l),
   ...
   var h, u, r, i, f, g, x, m, t, w = "transform",
      b = w + "Origin",
      ...
      P = function _placeSiblings(e, t) {
         var n, o, r, i, a, l, s = k(e),
            c = e === s,
            d = s ? E : S,
            p = e.parentNode;
         if (e === u)
            return e;
         if (d.length || d.push(v(e, 1), v(e, 2), v(e, 3)),
            n = s ? g : f,
            s)
            r = c ? {
               x: 0,
            ...
            a = (o = e.transform ? e.transform.baseVal : {}).numberOfItems ? (i = (o = 1 < o.numberOfItems ? function _consolidate(e) {
                  for (var t = new fe, n = 0; n < e.numberOfItems; n++)
                     t.multiply(e.getItem(n).matrix);
                  return t
               }(o) : o.getItem(0).matrix).a * r.x + o.c * r.y,
               o.b * r.x + o.d * r.y) : (o = x,
               i = r.x,
               r.y),
            ...
            if (i = a = 0,
               ...
               for (o = e.offsetParent,
                  ...
                  4 < (u.getComputedStyle(r)[w] + "").length && (i = r.offsetLeft,
                     a = r.offsetTop,
                     r = 0);
   ...
   function za(e) {
      Ee = e.touches && De < e.touches.length,
         wa(e.target, "touchend", za)
   }

   function Aa(e) {
      Ee = e.touches && De < e.touches.length,
         va(e.target, "touchend", za)
   }
   ...
   function Da(e, t) {
      va(e, "scroll", t),
         Fe(e.parentNode) || Da(e.parentNode, t)
   }

   function Ea(e, t) {
      wa(e, "scroll", t),
         Fe(e.parentNode) || Ea(e.parentNode, t)
   }
   ...
   function La(e) {
      if (e === xe)
         return p.left = p.top = 0,
            p.width = p.right = me.clientWidth || e.innerWidth || l.clientWidth || 0,
            p.height = p.bottom = (e.innerHeight || 0) - 20 < me.clientHeight ? me.clientHeight : e.innerHeight || l.clientHeight || 0,
            p;
      ...
      return X(n.right) && !X(n.width) ? (n.right = n.left + n.width,
            n.bottom = n.top + n.height) : X(n.width) && (n = {
   ...
   function Ma(e, t, n) {
      var o, r = e.vars,
         i = r[n],
         a = e._listeners[t];
      return V(i) && (o = i.apply(r.callbackScope || e, r[n + "Params"] || [e.pointerEvent])),
   ...
   function Wa(i, r) {
      ...
      var a, l, s, e, c, d, p = document.createElement("div"),
         ...
         w = 0,
         b = 0;
      R && !1 !== r.force3D ? (c = "translate3d(",
            d = "px,0px)") : O && (c = "translate(",
            d = "px)"),
         ...
         this.calibrate = function (e) {
            ...
            g = i.scrollTop,
               x = i.scrollLeft,
               r && i.clientHeight === l && p.offsetHeight === s && v === i.scrollWidth && m === i.scrollHeight && !e || ((h || f) && (n = this.left(),
                     o = this.top(),
                  ...
                  r && !e || (u.display = "block",
                     u.width = "auto",
                     u.paddingRight = "0px",
                     (y = Math.max(0, i.scrollWidth - i.clientWidth)) && (y += parseFloat(t.paddingLeft) + (B ? parseFloat(t.paddingRight) : 0))),
   ...
   function Xa(e) {
      if (T() && document.body) {
         ...
         xe = window,
            ...
            (ye = ba("div")).style.cssText = "visibility:hidden;height:1px;top:-1px;pointer-events:none;position:relative;clear:both;cursor:grab",
            Le = "grab" === ye.style.cursor ? "grab" : "move",
            Xe = t && -1 !== t.userAgent.toLowerCase().indexOf("android"),
            Me = "ontouchstart" in me && "orientation" in xe || t && (0 < t.MaxTouchPoints || 0 < t.msMaxTouchPoints),
            o = ba("div"),
            r = ba("div"),
            i = r.style,
            a = l,
            ...
            i.position = "relative",
            o.style.cssText = r.innerHTML = "width:90px;height:40px;padding:10px;overflow:auto;visibility:hidden",
            o.appendChild(r),
            a.appendChild(o),
      ...
      var n, o, r, i, a;
      ge ? (Se = ge.plugins.inertia,
         c = ge.utils.checkPrefix,
         O = c(O),
         _e = c(_e),
         be = ge.utils.toArray,
         R = !!c("perspective")) : e && console.warn("Please gsap.registerPlugin(Draggable)")
   }
   var ge, xe, ve, me, l, s, ye, we, c, be, d, Me, Te, De, Ee, Xe, Se, Le, Ye, R, B, n, O = "transform",
      ...
      A = function _getElementBounds(e, t) {
         t = be(t)[0];
         var n, o, r, i, a, l, s, c, d, p, u, h, f, g, x = e.getBBox && e.ownerSVGElement,
            v = e.ownerDocument || ve;
         if (e === xe)
            r = Ba(v),
            o = (n = Ca(v)) + (v.documentElement.clientWidth || e.innerWidth || v.body.clientWidth || 0),
            i = r + ((e.innerHeight || 0) - 20 < v.documentElement.clientHeight ? v.documentElement.clientHeight : e.innerHeight || v.body.clientHeight || 0);
         else {
            if (t === xe || X(t))
               return e.getBoundingClientRect();
            n = r = 0,
               x ? (u = (p = e.getBBox()).width,
                  h = p.height) : (e.viewBox && (p = e.viewBox.baseVal) && (n = p.x || 0,
                     r = p.y || 0,
                     u = p.width,
                     h = p.height),
                  u || (p = "border-box" === (f = Ja(e)).boxSizing,
   ...
   function Draggable(h, p) {
      ...
      function ph(e) {
         if (Q.autoScroll && Q.isDragging && (ee || k)) {
            var t, n, o, r, i, a, l, s, c = h,
               d = 15 * Q.autoScroll;
            for (ee = !1,
               Ie.scrollTop = null != xe.pageYOffset ? xe.pageYOffset : null != ce.documentElement.scrollTop ? ce.documentElement.scrollTop : ce.body.scrollTop,
               Ie.scrollLeft = null != xe.pageXOffset ? xe.pageXOffset : null != ce.documentElement.scrollLeft ? ce.documentElement.scrollLeft : ce.body.scrollLeft,
               r = Q.pointerX - Ie.scrollLeft,
               i = Q.pointerY - Ie.scrollTop; c && !n;)
               ...
               a = l = 0,
               U && ((s = t._gsMaxScrollY - t.scrollTop) < 0 ? l = s : i > o.bottom - oe && s ? (ee = !0,
                     l = Math.min(s, d * (1 - Math.max(0, o.bottom - i) / oe) | 0)) : i < o.top + te && t.scrollTop && (ee = !0,
                     l = -Math.min(t.scrollTop, d * (1 - Math.max(0, i - o.top) / te) | 0)),
                  l && (t.scrollTop += l)),
               K && ((s = t._gsMaxScrollX - t.scrollLeft) < 0 ? a = s : r > o.right - ne && s ? (ee = !0,
                     a = Math.min(s, d * (1 - Math.max(0, o.right - r) / ne) | 0)) : r < o.left + re && t.scrollLeft && (ee = !0,
                     a = -Math.min(t.scrollLeft, d * (1 - Math.max(0, r - o.left) / re) | 0)),
                  a && (t.scrollLeft += a)),
               n && (a || l) && (xe.scrollTo(t.scrollLeft, t.scrollTop),
         ...
         if (k) {
            var p = Q.x,
               u = Q.y;
            z ? (Q.deltaX = p - parseFloat(le.rotation),
                  Q.rotation = p,
                  le.rotation = p + "deg",
                  le.renderTransform(1, le)) : f ? (U && (Q.deltaY = u - f.top(),
                     f.top(u)),
                  K && (Q.deltaX = p - f.left(),
                     f.left(p))) : q ? (U && (Q.deltaY = u - parseFloat(le.y),
                     le.y = u + "px"),
                  K && (Q.deltaX = p - parseFloat(le.x),
                     le.x = p + "px"),
                  le.renderTransform(1, le)) : (U && (Q.deltaY = u - parseFloat(h.style.top || 0),
                     h.style.top = u + "px"),
                  K && (Q.deltaX = p - parseFloat(h.style.left || 0),
                     h.style.left = p + "px")),
               !g || e || I || (!(I = !0) === Ma(Q, "drag", "onDrag") && (K && (Q.x -= Q.deltaX),
                     U && (Q.y -= Q.deltaY),
                     ph(!0)),
                  I = !1)
         }
      ...
      function qh(e, t) {
         ...
         h._gsap || (le = ge.core.getCache(h)),
            ...
            q ? (Q.x = parseFloat(le.x),
               Q.y = parseFloat(le.y)) : z ? Q.x = Q.rotation = parseFloat(le.rotation) : f ? (Q.y = f.top(),
               Q.x = f.left()) : (Q.y = parseFloat(h.style.top || (o = Ja(h)) && o.top) || 0,
               Q.x = parseFloat(h.style.left || (o || {}).left) || 0),
            (N || P || R) && !t && (Q.isDragging || Q.isThrowing) && (R && (He.x = Q.x,
                  He.y = Q.y,
                  (n = R(He)).x !== Q.x && (Q.x = n.x,
                     k = !0),
                  n.y !== Q.y && (Q.y = n.y,
                     k = !0)),
               N && (n = N(Q.x)) !== Q.x && (Q.x = n,
      ...
      function th() {
         ...
         D = !1,
            f ? (f.calibrate(),
               ...
               Q.maxX = E = Q.maxY = L = 0,
               D = !0) : p.bounds && (e = Na(p.bounds, h.parentNode),
               z ? (Q.minX = S = e.left,
                  Q.maxX = E = e.left + e.width,
                  Q.minY = Y = Q.maxY = L = 0) : X(p.bounds.maxX) && X(p.bounds.maxY) ? (t = Na(h, h.parentNode),
                  Q.minX = S = Math.round(Jg(d, "px") + e.left - t.left - .5),
                  Q.minY = Y = Math.round(Jg(J, "px") + e.top - t.top - .5),
                  Q.maxX = E = Math.round(S + (e.width - t.width)),
                  Q.maxY = L = Math.round(Y + (e.height - t.height))) : (e = p.bounds,
                  Q.minX = S = e.minX,
                  Q.minY = Y = e.minY,
                  Q.maxX = E = e.maxX,
                  Q.maxY = L = e.maxY),
            ...
            p.liveSnap && (n = !0 === p.liveSnap ? p.snap || {} : p.liveSnap,
               o = Ce(n) || V(n),
               z ? (N = rh(o ? n : n.rotation, S, E, 1),
                  P = null) : n.points ? R = function buildPointSnapFunc(s, l, c, d, p, u, h) {
                  return u = u && u < Ne ? u * u : Ne,
                     V(s) ? function (e) {
               ...
               }(o ? n : n.points, S, E, Y, L, n.radius, f ? -1 : 1) : (K && (N = rh(o ? n : n.x || n.left || n.scrollLeft, S, E, f ? -1 : 1)),
                  U && (P = rh(o ? n : n.y || n.top || n.scrollTop, Y, L, f ? -1 : 1))))
      }

      function uh() {
         Q.isThrowing = !1,
            Ma(Q, "throwcomplete", "onThrowComplete")
      }
      ...
      function wh(e, t) {
         ...
         e && Se ? (!0 === e && (n = p.snap || p.liveSnap || {},
               ...
               z ? e.rotation = Qa(Q, o ? n : n.rotation, E, S, 1, t) : (K && (e[d] = Qa(Q, o ? n : n.points || n.x || n.left, E, S, f ? -1 : 1, t || "x" === Q.lockedAxis)),
                  U && (e[J] = Qa(Q, o ? n : n.points || n.y || n.top, L, Y, f ? -1 : 1, t || "y" === Q.lockedAxis)),
                  (n.points || Ce(n) && W(n[0])) && (e.linkedProps = d + "," + J,
                     e.radius = n.radius))),
            Q.isThrowing = !0,
            ...
            p.fastMode || (f && (f._skip = !0),
               ...
               r.play(0),
               qh(!0, !0),
               f && (f._skip = !1))) : D && Q.applyBounds()
      }

      function xh(e) {
         var t, n = B;
         B = getGlobalMatrix(h.parentNode, !0),
            e && Q.isPressed && !B.equals(n || new fe) && (t = n.inverse().apply({
                  x: w,
                  y: b
               }),
               B.apply(t, t),
      ...
      function yh() {
         ...
         xh(!1),
            ...
            w = We.x,
            b = We.y,
            k && (ue(Q.pointerX, Q.pointerY),
               ph(!0)),
            f ? (th(),
               T = f.top(),
               M = f.left()) : (de() ? (qh(!0, !0),
                  th()) : Q.applyBounds(),
               z ? (e = h.ownerSVGElement ? [le.xOrigin - h.getBBox().x, le.yOrigin - h.getBBox().y] : (Ja(h)[_e] || "0 0").split(" "),
                  ...
                  n = C.y - Q.pointerY + i,
                  M = Q.x,
                  T = Q.y = Math.atan2(n, t) * ke) : (T = Jg(J, "px"),
                  M = Jg(d, "px"))),
            D && o && (E < M ? M = E + (M - E) / o : M < S && (M = S - (S - M) / o),
               z || (L < T ? T = L + (T - L) / o : T < Y && (T = Y - (Y - T) / o))),
            Q.startX = M = _(M),
            Q.startY = T = _(T)
      }
      ...
      function Bh(e, t) {
         var n;
         if (!u || Q.isPressed || !e || !("mousedown" !== e.type && "pointerdown" !== e.type || t) && Pe() - ae < 30 && Te[Q.pointerEvent.type])
            G && e && u && xa(e);
         else {
            if (O = de(),
               Q.pointerEvent = e,
               Te[e.type] ? (y = ~e.type.indexOf("touch") ? e.currentTarget || e.target : ce,
                  va(y, "touchend", he),
                  va(y, "touchmove", pe),
                  va(y, "touchcancel", he),
                  va(ce, "touchstart", Aa)) : (y = null,
                  va(ce, "mousemove", pe)),
               H = null,
               Ye && y || (va(ce, "mouseup", he),
                  e && e.target && va(e.target, "mouseup", he)),
               m = ie.call(Q, e.target) && !1 === p.dragClickables && !t)
               return va(e.target, "change", he),
                  Ma(Q, "pressInit", "onPressInit"),
                  Ma(Q, "press", "onPress"),
                  Sa(Z, !0),
                  void(G = !1);
            if (A = !(!y || K == U || !1 === Q.vars.allowNativeTouchScrolling || Q.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which)) && (K ? "y" : "x"),
               (G = !A && !Q.allowEventDefault) && (xa(e),
                  va(xe, "touchforcechange", xa)),
               e.changedTouches ? (e = x = e.changedTouches[0],
                  v = e.identifier) : e.pointerId ? v = e.pointerId : x = v = null,
               De++,
               function _addToRenderQueue(e) {
                  Re.push(e),
                     1 === Re.length && ge.ticker.add(qa)
               }(ph),
               b = Q.pointerY = e.pageY,
               w = Q.pointerX = e.pageX,
               Ma(Q, "pressInit", "onPressInit"),
               (A || Q.autoScroll) && Ha(h.parentNode),
               !h.parentNode || !Q.autoScroll || f || z || !h.parentNode._gsMaxScrollX || ye.parentNode || h.getBBox || (ye.style.width = h.parentNode.scrollWidth + "px",
               ...
               !p.zIndexBoost && (z || f || !1 === p.zIndexBoost) || (h.style.zIndex = Draggable.zIndex++),
               Q.isPressed = !0,
      ...
      function Gh(e) {
         ...
         n || o || (e && e.target && (Q.pointerEvent = e),
            Ma(Q, "click", "onClick"))
      }
      ...
      var u, f, w, b, M, T, D, g, s, E, S, L, Y, x, v, C, k, t, N, P, R, m, y, B, O, A, H, I, F, c, G, n = (p.type || "x,y").toLowerCase(),
         ...
         pe = function onMove(e) {
            ...
            if (u && !Ee && Q.isPressed && e) {
               if (t = (Q.pointerEvent = e).changedTouches) {
                  ...
                  return;
               y && A && !H && (We.x = e.pageX - (se ? Ca(ce) : 0),
                  We.y = e.pageY - (se ? Ba(ce) : 0),
                  B && B.apply(We, We),
                  n = We.x,
                  o = We.y,
                  ((i = Math.abs(n - w)) !== (a = Math.abs(o - b)) && (j < i || j < a) || Xe && A === H) && (H = a < i && K ? "x" : "y",
                     A && H !== A && va(xe, "touchforcechange", xa),
                     !1 !== Q.vars.lockAxisOnTouchScroll && K && U && (Q.lockedAxis = "x" === H ? "y" : "x",
                        V(Q.vars.onLockAxis) && Q.vars.onLockAxis.call(Q, l)),
                     Xe && A === H)) ? he(l) : (G = Q.allowEventDefault || A && (!H || A === H) || !1 === l.cancelable ? G && !1 : (xa(l),
                     !0),
                  Q.autoScroll && (ee = !0),
         ...
         ue = function setPointerPosition(e, t, n) {
            ...
            Q.pointerX = e,
               ...
               se && (e -= Ca(ce),
                  t -= Ba(ce)),
               z ? (a = Math.atan2(C.y - t, e - C.x) * ke,
                  180 < (l = Q.y - a) ? (T -= 360,
                     Q.y = a) : l < -180 && (T += 360,
                     Q.y = a),
                  i = Q.x !== M || Math.abs(T - a) > j ? (Q.y = a,
                     M + (T - a) * c) : M) : (B && (s = e * B.a + t * B.c + B.e,
                     t = e * B.b + t * B.d + B.f,
                     e = s),
                  (r = t - b) < j && -j < r && (r = 0),
                  (o = e - w) < j && -j < o && (o = 0),
                  (Q.lockAxis || Q.lockedAxis) && (o || r) && ((s = Q.lockedAxis) || (Q.lockedAxis = s = K && Math.abs(o) > Math.abs(r) ? "y" : U ? "x" : null,
                        s && V(Q.vars.onLockAxis) && Q.vars.onLockAxis.call(Q, Q.pointerEvent)),
                     "y" === s ? r = 0 : "x" === s && (o = 0)),
                  i = _(M + o * c),
                  a = _(T + r * c)),
               (N || P || R) && (Q.x !== i || Q.y !== a && !z) ? (R && (He.x = i,
                     He.y = a,
                     s = R(He),
                     i = _(s.x),
                     a = _(s.y)),
                  N && (i = _(N(i))),
                  P && (a = _(P(a)))) : D && (E < i ? i = E + Math.round((i - E) * d) : i < S && (i = S + Math.round((i - S) * d)),
                  z || (L < a ? a = Math.round(L + (a - L) * d) : a < Y && (a = Math.round(Y + (a - Y) * d)))),
               Q.x === i && (Q.y === a || z) || (z ? (Q.endRotation = Q.x = Q.endX = i,
                     k = !0) : (U && (Q.y = Q.endY = a,
                        k = !0),
                     K && (Q.x = Q.endX = i,
                        k = !0)),
                  n && !1 === Ma(Q, "move", "onMove") ? (Q.pointerX = p,
                     Q.pointerY = u,
                     T = h,
                     Q.x = f,
                     Q.y = g,
                     ...
                     Q.endY = v,
                     Q.endRotation = m,
                     k = y) : !Q.isDragging && Q.isPressed && (Q.isDragging = !0,
                     Ma(Q, "dragstart", "onDragStart")))
         },
         he = function onRelease(e, t) {
            if (u && Q.isPressed && (!e || null == v || t || !(e.pointerId && e.pointerId !== v && e.target !== h || e.changedTouches && ! function _hasTouchID(e, t) {
               ...
               if (y ? (wa(y, "touchend", onRelease),
                     wa(y, "touchmove", pe),
                     wa(y, "touchcancel", onRelease),
                     wa(ce, "touchstart", Aa)) : wa(ce, "mousemove", pe),
                  wa(xe, "touchforcechange", xa),
                  Ye && y || (wa(ce, "mouseup", onRelease),
                     e && e.target && wa(e.target, "mouseup", onRelease)),
                  k = !1,
                  s && ($ = Ae = Pe(),
                     Q.isDragging = !1),
                  m && !c)
                  return e && (wa(e.target, "change", onRelease),
                        Q.pointerEvent = l),
                     Sa(Z, !1),
               ...
               return c && l ? (xa(l),
                     G = !0,
                     Ma(Q, "release", "onRelease")) : l && !s ? (G = !1,
                     O && (p.snap || p.bounds) && wh(p.inertia || p.throwProps),
                     Ma(Q, "release", "onRelease"),
                     Xe && "touchmove" === l.type || -1 !== l.type.indexOf("cancel") || (Ma(Q, "click", "onClick"),
                        Pe() - ae < 300 && Ma(Q, "doubleclick", "onDoubleClick"),
                        i = l.target || h,
                        ae = Pe(),
                        a = function syntheticClick() {
                           ae === F || !Q.enabled() || Q.isPressed || l.defaultPrevented || (i.click ? i.click() : ce.createEvent && ((r = ce.createEvent("MouseEvents")).initMouseEvent("click", !0, !0, xe, 1, Q.pointerEvent.screenX, Q.pointerEvent.screenY, Q.pointerX, Q.pointerY, !1, !1, !1, !1, 0, null),
                              i.dispatchEvent(r)))
                        },
                        Xe || l.defaultPrevented || ge.delayedCall(.05, a))) : (wh(p.inertia || p.throwProps),
                     Q.allowEventDefault || !l || !1 === p.dragClickables && ie.call(Q, l.target) || !s || A && (!H || A !== H) || !1 === l.cancelable ? G = !1 : (G = !0,
                        xa(l)),
                     Ma(Q, "release", "onRelease")),
      ...
      return (t = Draggable.get(h)) && t.kill(),
         e.startDrag = function (e, t) {
            ...
            Bh(e || Q.pointerEvent, !0),
               t && !Q.hitTest(e || Q.pointerEvent) && (n = La(e || Q.pointerEvent),
                  o = La(h),
                  r = Hh({
                     x: n.left + n.width / 2,
                     y: n.top + n.height / 2
         ...
         e.getDirection = function (e, t) {
            ...
            return "element" === s && (a = La(Q.target),
                  l = La(e)),
               n = "start" === s ? Q.x - M : "velocity" === s ? Se.getVelocity(h, d) : a.left + a.width / 2 - (l.left + l.width / 2),
               z ? n < 0 ? "counter-clockwise" : "clockwise" : (t = t || 2,
                  o = "start" === s ? Q.y - T : "velocity" === s ? Se.getVelocity(h, J) : a.top + a.height / 2 - (l.top + l.height / 2),
            ...
            if (qh(!0),
               ...
               if (n = Q.x,
                  ...
                  for (Ha(h.parentNode),
                     i = h,
                     Ie.scrollTop = null != xe.pageYOffset ? xe.pageYOffset : null != ce.documentElement.scrollTop ? ce.documentElement.scrollTop : ce.body.scrollTop,
                     Ie.scrollLeft = null != xe.pageXOffset ? xe.pageXOffset : null != ce.documentElement.scrollLeft ? ce.documentElement.scrollLeft : ce.body.scrollLeft; i && !l;)
         ...
         e.update = function (e, t, n) {
            var o = Q.x,
               r = Q.y;
            return xh(!t),
               e ? Q.applyBounds() : (k && n && ph(!0),
                  qh(!0)),
               t && (ue(Q.pointerX, Q.pointerY),
                  k && ph(!0)),
               Q.isPressed && !t && (K && .01 < Math.abs(o - Q.x) || U && .01 < Math.abs(r - Q.y) && !z) && yh(),
               Q.autoScroll && (Ha(h.parentNode, Q.isDragging),
                  ee = Q.isDragging,
                  ph(!0),
                  Ea(h, Fh),
                  Da(h, Fh)),
         ...
         e.enable = function (e) {
            ...
            if (!1 !== p.cursor && (r.cursor = p.cursor || Le),
               ge.utils.checkPrefix("touchCallout") && (r.touchCallout = "none"),
               "soft" !== e) {
               for (pa(Z, K == U ? "none" : p.allowNativeTouchScrolling && h.scrollHeight === h.clientHeight == (h.scrollWidth === h.clientHeight) || p.allowEventDefault ? "manipulation" : K ? "pan-y" : "pan-x"),
                  n = Z.length; - 1 < --n;)
                  o = Z[n],
                  ...
                  va(o, "click", Gh, !0),
                  ge.set(o, r),
                  o.getBBox && o.ownerSVGElement && ge.set(o.ownerSVGElement, {
            ...
            return Da(h, Fh),
               u = !0,
               Se && "soft" !== e && Se.track(f || h, q ? "x,y" : z ? "rotation" : "top,left"),
               h._gsDragID = t = "d" + Oe++,
               Be[t] = Q,
               f && (f.enable(),
         ...
         e.disable = function (e) {
            ...
            if ("soft" !== e) {
               for (pa(Z, null),
                  o = Z.length; - 1 < --o;)
                  t = Z[o],
                  Ia(t, "touchCallout", null),
                  wa(t, "mousedown", Bh),
                  wa(t, "touchstart", Bh),
                  wa(t, "click", Gh),
                  wa(t, "contextmenu", oh);
               Sa(Z, !0),
                  y && (wa(y, "touchcancel", he),
                     wa(y, "touchend", he),
                     wa(y, "touchmove", pe)),
                  wa(ce, "mouseup", he),
                  wa(ce, "mousemove", pe)
            ...
            return Ea(h, Fh),
               u = !1,
               Se && "soft" !== e && Se.untrack(f || h, q ? "x,y" : z ? "rotation" : "top,left"),
               f && f.disable(),
               ta(ph),
               Q.isDragging = Q.isPressed = m = !1,
               n && Ma(Q, "dragend", "onDragEnd"),
               Q
         },
